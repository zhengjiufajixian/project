			...
			<swiper class="swiper-box" :current="swiperCurrent" @transition="transition" @animationfinish="animationfinish">
					...
					<scroll-view scroll-y style="height: 100%;width: 100%;" @scrolltolower="reachBottom">
						<view class="page-box" v-if="orderList[0].length>0">
							<navigator :url="'orderDetail/orderDetail?orderId='+item.id" class="order" v-for="(item, index) in orderList[0]"
							 :key="index">
								<view class="u-flex u-col-center u-row-between u-padding-bottom-15 u-font-24">
									<view class="color-333333 u-font-24">
										<text class="bold">店铺名称: </text><text>{{item.shop.shopName}}</text>
									</view>
								</view>
								<view class="u-flex u-col-center u-row-between u-padding-bottom-15 u-font-24">
									<view class="color-333333">
										<text class="bold">订单ID: </text><text>{{item.id}}</text>
									</view>
								...
								<view class="u-flex u-col-center u-row-between u-margin-top-14">
									...
									<view class="">
										<u-button size="mini" shape="circle" hover-class="none" :hair-line="false" :custom-style="getBtnStyle(item)"
										 @click="getBtnClick(item,index)">{{getBtnText(item)}}</u-button>
									</view>
								</view>
							</navigator>
				...
				<swiper-item class="swiper-item">
					<scroll-view scroll-y style="height: 100%;width: 100%;" @scrolltolower="reachBottom">
						...
						<u-empty paddingTop="250" src="/static/image/nodata.png" v-else></u-empty>
					</scroll-view>
				</swiper-item>
				<swiper-item class="swiper-item">
					<scroll-view scroll-y style="height: 100%;width: 100%;" @scrolltolower="reachBottom">
						<view class="page-box" v-if="orderList[2].length>0">
							<navigator :url="'orderDetail/orderDetail?orderId='+item.id" class="order" v-for="(item, index) in orderList[2]"
							 :key="index">
								<view class="u-flex u-col-center u-row-between u-padding-bottom-15 u-font-24">
									<view class="color-333333 u-font-24">
										<text class="bold">店铺名称: </text><text>{{item.shop.shopName}}</text>
