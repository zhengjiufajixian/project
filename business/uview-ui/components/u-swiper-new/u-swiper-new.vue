		...
		<view style="padding: 20upx;background-color: #FFFFFF;">
			<scroll-view class="scroll-view_H" scroll-x="true" :scroll-left="scrollLeft">
				...
				<view v-for="(item, index) in list" :key="index"
				 :class="uCurrent == index?'cur':''"
				 class="scroll-view-item_H" 
				  style="width: 159upx;height: 104upx;margin: 10upx;">
					<image @click="xz(index)" class="u-swiper-image" :src="item[name] || item" :mode="imgMode" style="width: 155upx;height: 100upx;"></image>
				</view>			
			</scroll-view>
