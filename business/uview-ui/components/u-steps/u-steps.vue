	...
	<view class="">
		<view class="u-steps" :style="{
			...
			<view class="u-steps__item" :class="['u-steps__item--' + direction]" v-for="(item, index) in list" :key="index">
				...
				<view class="u-steps__item__dot u-flex u-col-center u-row-center" v-else>
					<view class="u-steps__item__dot__point" :style="{backgroundColor: index <= current ? activeColor : unActiveColor }"></view>
				</view>
