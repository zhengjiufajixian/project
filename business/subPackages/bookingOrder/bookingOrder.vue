				...
				<swiper-item class="swiper-item" v-for="(listItem,listIndex) in list" :key="listIndex">
					<scroll-view scroll-y style="height: 100%;width: 100%;" @scrolltolower="reachBottom">
						<view class="page-box" v-if="orderList[listIndex].length>0">
							<navigator :url="'/pages/order/orderDetail/orderDetail?orderId='+item.id" class="order"
								...
								<view
									class="u-flex u-col-center u-row-between u-padding-top-26 u-padding-bottom-14 u-padding-left-18 u-padding-right-18 u-font-24 bold">
									<view class="u-line-1 color-4A4A4A">
										{{item.orderType == "WX"?"维修预约单":"保养预约单"}}
									</view>
